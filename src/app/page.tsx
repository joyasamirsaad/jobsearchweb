    ...
    return (
        <div className="bg-[#FBFBFB]">
            <div className="container mx-auto px-4 md:px-20">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4"> {/*How it works*/}
                    <h1 className="mt-30 col-span-1 lg:col-span-2">How it works</h1>
                    ...
                    <div className="order-2 lg:order-3 col-span-1 lg:col-span-2">
                        <div className="grid grid-cols-1 grid-cols-2 lg:grid-cols-4 gap-8 mt-8 mb-8">
                    ...
                    <div className="flex items-center justify-center lg:justify-end order-3 lg:order-2 lg:col-start-2 lg:row-start-2">
            ...
            <div className="relative z-10 flex justify-center px-4 md:px-8"> {/*Register CV*/}
